...
public class getLowArrInfoByRouteList extends Thread {
	Handler mhandler;
	int mwhat;
	int count;

	String addr = "http://ws.bus.go.kr/api/rest/arrive/";
	String function = "getLowArrInfoByRoute";
	String servicekey;
	...
	getLowArrInfoByRouteList_Element Data;

	public getLowArrInfoByRouteList(Handler phandler, int pwhat) {
		mhandler = phandler;
		mwhat = pwhat;
	...
	public getLowArrInfoByRouteList(Handler phandler, int pwhat, String serviceKey, String parameter1, String parameter2, String parameter3) {
		mhandler = phandler;
		mwhat = pwhat;
	...
	public void run() {
    	Data = new getLowArrInfoByRouteList_Element();
	...
	public getLowArrInfoByRouteList_Element getElement() {
		return Data;
