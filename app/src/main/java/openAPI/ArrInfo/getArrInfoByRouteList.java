...
public class getArrInfoByRouteList extends Thread {
	Handler mhandler;
	int mwhat;
	int count;

	String addr = "http://ws.bus.go.kr/api/rest/arrive/";
	String function = "getArrInfoByRoute";
	String servicekey;
	...
	getArrInfoByRouteList_Element Data;

	public getArrInfoByRouteList(Handler phandler, int pwhat) {
		mhandler = phandler;
		mwhat = pwhat;
	...
	public getArrInfoByRouteList(Handler phandler, int pwhat, String serviceKey, String parameter1, String parameter2, String parameter3) {
		mhandler = phandler;
		mwhat = pwhat;
	...
	public void run() {
    	Data = new getArrInfoByRouteList_Element();
	...
	public getArrInfoByRouteList_Element getElement() {
		return Data;
