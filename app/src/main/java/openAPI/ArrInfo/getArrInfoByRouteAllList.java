...
public class getArrInfoByRouteAllList extends Thread {
	Handler mhandler;
	int mwhat;
	int count;

	String addr = "http://ws.bus.go.kr/api/rest/arrive/";
	String function = "getArrInfoByRouteAll";
	String servicekey;

	String fullparam = "";
	String param1 = "&busRouteId=";

	getArrInfoByRouteAllList_Element Data;

	public getArrInfoByRouteAllList(Handler phandler, int pwhat) {
		mhandler = phandler;
		mwhat = pwhat;
	...
	public getArrInfoByRouteAllList(Handler phandler, int pwhat, String serviceKey, String parameter1) {
		mhandler = phandler;
		mwhat = pwhat;
	...
	public void run() {
    	Data = new getArrInfoByRouteAllList_Element();
	...
	public getArrInfoByRouteAllList_Element getElement() {
		return Data;
